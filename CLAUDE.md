...
- Python and JavaScript versions, package managers, command runner, formatters, linters, type checks,
  and test commands were pinned in M0 and are used consistently. WP1.2 manages the shot-focused
  schema through ordered, hand-written SQL migrations; idempotent ingestion arrives in WP1.3.
